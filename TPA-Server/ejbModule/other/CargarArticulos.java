...
public class CargarArticulos {
	...
	public void cargaDeDatos(){
		...
		// Alta de DetalleMovimientoStock
		// idMovimientoStock, IdArticulo, tipoMovimiento y Cantidad
		
		MovimientoStockBean movimientoStock01 = new MovimientoStockBean();
		movimientoStock01.setArticulo(articulo01);
		movimientoStock01.setCantidad(10);
		movimientoStock01.setTipoMovimiento("Tipo movimiento 01");
		
		MovimientoStockBean movimientoStock02 = new MovimientoStockBean();
		movimientoStock02.setArticulo(articulo02);
		movimientoStock02.setCantidad(20);
		movimientoStock02.setTipoMovimiento("Tipo movimiento 02");
		
		MovimientoStockBean movimientoStock03 = new MovimientoStockBean();
		movimientoStock03.setArticulo(articulo01);
		movimientoStock03.setCantidad(30);
		movimientoStock03.setTipoMovimiento("Tipo movimiento 03");
		
		MovimientoStockBean movimientoStock04 = new MovimientoStockBean();
		movimientoStock04.setArticulo(articulo04);
		movimientoStock04.setCantidad(40);
		movimientoStock04.setTipoMovimiento("Tipo movimiento 04");
		
		MovimientoStockBean movimientoStock05 = new MovimientoStockBean();
		movimientoStock05.setArticulo(articulo04);
		movimientoStock05.setCantidad(50);
		movimientoStock05.setTipoMovimiento("Tipo movimiento 05");
		
		MovimientoStockBean movimientoStock06 = new MovimientoStockBean();
		movimientoStock06.setArticulo(articulo06);
		movimientoStock06.setCantidad(60);
		movimientoStock06.setTipoMovimiento("Tipo movimiento 06");
		
		MovimientoStockBean movimientoStock07 = new MovimientoStockBean();
		movimientoStock07.setArticulo(articulo01);
		movimientoStock07.setCantidad(70);
		movimientoStock07.setTipoMovimiento("Tipo movimiento 07");
		
		MovimientoStockBean movimientoStock08 = new MovimientoStockBean();
		movimientoStock08.setArticulo(articulo08);
		movimientoStock08.setCantidad(80);
		movimientoStock08.setTipoMovimiento("Tipo movimiento 08");
		
		MovimientoStockBean movimientoStock09 = new MovimientoStockBean();
		movimientoStock09.setArticulo(articulo06);
		movimientoStock09.setCantidad(90);
		movimientoStock09.setTipoMovimiento("Tipo movimiento 09");
		
		MovimientoStockBean movimientoStock10 = new MovimientoStockBean();
		movimientoStock10.setArticulo(articulo01);
		movimientoStock10.setCantidad(110);
		movimientoStock10.setTipoMovimiento("Tipo movimiento 10");
		
		movimientoStock01.persistDetalleMovimientoStock();
		movimientoStock02.persistDetalleMovimientoStock();
		movimientoStock03.persistDetalleMovimientoStock();
		movimientoStock04.persistDetalleMovimientoStock();
		movimientoStock05.persistDetalleMovimientoStock();
		movimientoStock06.persistDetalleMovimientoStock();
		movimientoStock07.persistDetalleMovimientoStock();
		movimientoStock08.persistDetalleMovimientoStock();
		movimientoStock09.persistDetalleMovimientoStock();
		movimientoStock10.persistDetalleMovimientoStock();
